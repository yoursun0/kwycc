...
<div id="slideshow-<?php echo $widget_id; ?>" class="wk-slideshow wk-slideshow-circumference" data-widgetkit="slideshow" data-options='<?php echo json_encode($settings); ?>'>
	<div>
		<ul class="slides">
	...
	<?php echo ($settings['navigation'] && count($navigation)) ? '<div class="slidernav hidden-xs"><ul class="nav">'.implode('', $navigation).'</ul></div>' : '';?>
</div>