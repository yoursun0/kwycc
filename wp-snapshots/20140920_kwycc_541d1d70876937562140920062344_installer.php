...
$GLOBALS['FW_PACKAGE_NAME'] = '20140920_kwycc_541d1d70876937562140920062344_archive.zip';
$GLOBALS['FW_PACKAGE_NOTES'] = 'test data migration kwycc';
$GLOBALS['FW_SECURE_NAME'] = '20140920_kwycc_541d1d70876937562140920062344';
$GLOBALS['FW_DBHOST'] = 'localhost';
$GLOBALS['FW_DBHOST'] = empty($GLOBALS['FW_DBHOST']) ? 'localhost' : $GLOBALS['FW_DBHOST'];
$GLOBALS['FW_DBNAME'] = 'kwycc';
